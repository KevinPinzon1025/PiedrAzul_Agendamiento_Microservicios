...
import co.unicauca.frontend.view.LoginFrame;
...
/*
 * TODO
 * -la cita se registra pero, donde esta registrando la hora? habra que
 * modificar eso cuando se carguen los slots de los medicos
 ...
 * LocalDate date
 * )
 * -En el backend configurar el DTO que recibe para gestionar agendador y
 * recibir si es una cita manual o una cita autonoma
 */