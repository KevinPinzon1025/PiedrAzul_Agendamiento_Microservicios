...
public class ScheduleAppointmentFrame extends Application {
    ...
    private Node createToolbar() {
        ...
        Button btnAgendar = createNavButton("Agendar cita", true);
        Button btnListar = createNavButton("Consultar citas", false);
    ...
    private Node createForm() {
        ...
        Label title = new Label("Agendar una cita");
        title.setFont(Font.font("System", FontWeight.BOLD, 32));
        title.setStyle("-fx-text-fill: #163b5b;");

        Label subtitle = new Label("Seleccione paciente, profesional y fecha. Luego escriba el motivo de la consulta.");
    ...
    private HBox createTopActions() {
        ...
        Button btnNewPatient = createSecondaryButton("Nuevo paciente");
        btnNewPatient.setOnAction(e -> lblFeedback.setText("La creación de pacientes se conectará en una siguiente versión."));

        Button btnConsultarHorarios = createSecondaryButton("Consultar horarios");
        btnConsultarHorarios.setOnAction(e -> lblFeedback.setText("La consulta de horarios se conectará próximamente."));
    ...
    private Node createFormGrid() {
        ...
        styleField(cbTime);
        cbTime.getItems().setAll("10:00");
        cbTime.setValue("10:00");

        txtMotivo = new TextArea();
        txtMotivo.setPromptText("Describa brevemente el motivo de la consulta");
        txtMotivo.setWrapText(true);
        txtMotivo.setPrefHeight(150);
        txtMotivo.setFont(Font.font("System", 17));
        txtMotivo.setStyle(
        ...
        form.add(createFieldBox("Motivo de la consulta", txtMotivo), 0, 2, 2, 1);
    ...
    private HBox createBottomActions() {
        ...
        btnRegister.setFont(Font.font("System", FontWeight.BOLD, 19));
        ...
        btnClear.setFont(Font.font("System", FontWeight.BOLD, 19));
        btnClear.setStyle(
    ...
    private Button createSecondaryButton(String text) {
        ...
        button.setFont(Font.font("System", FontWeight.BOLD, 17));
        button.setStyle(
                "-fx-background-color: #f8fbff;" +
                        "-fx-text-fill: #1f6fb2;" +
    ...
    private void registerAppointment() {
        try {
            ...
            if (patientName == null || professionalName == null || date == null || observation == null || observation.isBlank()) {
                lblFeedback.setStyle(
                        "-fx-text-fill: #8f1d1d;" +
            ...
            request.setAppointmentDate(date.atTime(10, 0));
            request.setSchedulingType(SchedulingType.MANUAL);

            //TODO AGENDADOR QUEMADO SOLO PARA PRUEBAS, DESPUES, SE LEE DE LA SESSION INICIADA
            ...
            lblFeedback.setText("La cita se registró correctamente.");
            clearForm();
        } catch (Exception ex) {
            ex.printStackTrace();
            lblFeedback.setStyle(
            ...
            lblFeedback.setText("Ocurrió un error al registrar la cita.");
        }
    }
    ...
    private void initData() {
        try {
            ...
            lblFeedback.setText("No se pudieron cargar pacientes y profesionales.");
        }
    }
    ...
    private void logout() {
        try {
            ...
            lblFeedback.setText("No fue posible cerrar sesión.");
        }
    }
